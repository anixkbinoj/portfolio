    ...
    <>
      ...
      {media && (
        ...
        >
          ...
          >
            <div className="w-24 h-28 md:w-28 md:h-32 rounded-sm overflow-hidden border border-ivory/30 shadow-[0_0_30px_rgba(20,26,38,0.6)] bg-ink-2">
      ...
      {label && (
        ...
        >
          <motion.div
            className="whitespace-nowrap font-mono text-[0.52rem] tracking-[0.28em] uppercase text-ink bg-ivory px-4 py-2 rounded-sm"
      ...
      >
        <motion.div
          className="rounded-full border border-ivory/50"
          animate={{
            width: hovering ? 64 : 28,
            height: hovering ? 64 : 28,
            opacity: label || media ? 0.25 : hovering ? 1 : 0.6,
            scale: down ? 0.85 : 1,
          }}
      ...
      >
        <div className="w-1.5 h-1.5 rounded-full bg-ivory -translate-x-1/2 -translate-y-1/2" />
      </div>
    </>
  )
}